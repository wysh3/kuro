...
import { Clock, CheckCircle2, LogOut, BarChart3, Zap, Target, Activity, Sparkles } from 'lucide-react'
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <Button onClick={() => router.push('/kitchen/kuro')} variant="ghost" className="h-11 px-5 bg-white/5 hover:bg-white/10 transition-all rounded-2xl text-[9px] font-black tracking-widest sm:flex hidden group">
                <Sparkles className="w-4 h-4 mr-2 text-white group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all" /> KURO AI
              </Button>
