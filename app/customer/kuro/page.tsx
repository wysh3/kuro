                    ...
                    <div className={cn(
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            <button
                                ...
                                className="w-12 h-12 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/5 transition-all flex items-center justify-center text-white/40 hover:text-white group"
                                title="New Chat"
                            >
