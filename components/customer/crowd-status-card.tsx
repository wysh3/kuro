...
export function CrowdStatusCard() {
    ...
    return (
        <motion.div
            ...
            className="relative overflow-hidden rounded-[2rem] p-6 glass-panel border border-white/10 shadow-premium transition-all duration-500 bg-white/[0.015] hover:bg-white/[0.04]"
        >
            ...
            <div className="relative space-y-6">
                ...
                <div className="flex flex-row items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-[8px] font-black text-white/20 uppercase tracking-[0.4em] mb-1.5">Kitchen Traffic</h3>
                            <p className={`text-xl font-black tracking-tighter uppercase leading-none ${theme.text}`}>
                    ...
                    <div className="flex flex-col items-end">
                        <p className="text-[8px] font-black text-white/20 uppercase tracking-[0.4em] mb-1.5">Wait Time</p>
                        <div className="flex items-baseline gap-1">
                            <span className="text-2xl font-black text-white tracking-tighter leading-none">{status.estimatedWait}</span>
                ...
                <div className="grid grid-cols-2 gap-6 pt-6 border-t border-white/[0.05]">
                    <div className="space-y-2">
                        ...
                        <p className="text-xl font-black text-white tracking-tighter">98.2%</p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xl font-black text-white tracking-tighter leading-none">POKE BOWL</p>
                    </div>
                </div>
            </div>
        </motion.div>
...
function StatusMetric({ label, value, icon, color }: { label: string, value: string, icon: React.ReactNode, color: string }) {
    return (
        <div className="flex flex-col items-center gap-3 group/metric text-center">
            ...
            <p className={cn("text-2xl font-black tracking-tighter leading-none transition-all group-hover/metric:scale-110", color)}>{value}</p>
        </div>
    )
}
